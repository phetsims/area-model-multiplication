...
const AreaModelMultiplicationImages = {
  ...
  level6ImageProperty: new LocalizedImageProperty( 'level6', {
    ...
    africa: africaLevel6Icon_svg,
    africaModest: africaModestLevel6Icon_svg,
    asia: asiaLevel6Icon_svg,
    latinAmerica: latinAmericaLevel6Icon_svg,
    oceania: usaLevel6Icon_svg
  } )
};
